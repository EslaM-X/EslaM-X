...
| [**rhysd/actionlint**](https://github.com/rhysd/actionlint/pull/729) | CI/CD supply-chain security — added new lint rule to catch unsafe patterns in GitHub Actions workflows | [PR #729](https://github.com/rhysd/actionlint/pull/729) |
| [**buildpacks/pack**](https://github.com/buildpacks/pack/pull/2681) | CNCF Cloud Native Buildpacks — integrated cryptographic evidence attestation into release CI pipeline | [PR #2681](https://github.com/buildpacks/pack/pull/2681) |
| [**Fabric Foundation — RoboPay**](https://github.com/fabricfoundation/RoboPay) | External OSS — machine-payable robotics: Atlas [PR #120](https://github.com/fabricfoundation/RoboPay/pull/120), Spot [PR #86](https://github.com/fabricfoundation/RoboPay/pull/86) + Go2 [PR #89](https://github.com/fabricfoundation/RoboPay/pull/89) Tier-1, x402 gating | [PR #120](https://github.com/fabricfoundation/RoboPay/pull/120) · [PR #86](https://github.com/fabricfoundation/RoboPay/pull/86) · [PR #89](https://github.com/fabricfoundation/RoboPay/pull/89) · evidence in [portfolio](https://github.com/EslaM-X/portfolio) |
...
[![Medium](https://img.shields.io/badge/MEDIUM-0A0A0A?style=for-the-badge&logo=medium&logoColor=FFB627)](https://medium.com/@eslam.kora60)
...
<img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,nodejs,express,mongodb,postgres,supabase,tailwind,docker,git,github,go,python,rust,solidity,linux,vercel,figma,vscode&perline=10" alt="stack" />
